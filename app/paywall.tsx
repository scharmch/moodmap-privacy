...
const FEATURES = [
  {
    ...
    description: "Get personalized mood analysis and patterns powered by AI",
  },
  {
    icon: "📊",
    title: "Weekly Reports",
    description: "Detailed weekly summaries of your mood trends and progress",
  },
  {
    icon: "🗺",
    title: "Mood Map Analytics",
    description: "Advanced location-based mood insights and heatmaps",
  },
  {
    icon: "∞",
    title: "Unlimited History",
    description: "Access your complete mood history with no limits",
  },
];
...
export default function PaywallScreen() {
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      console.log('[Paywall] Purchase result:', success ? 'success' : 'not completed');
      if (success) {
  ...
  const handleRestore = async () => {
    ...
    try {
      ...
      console.log('[Paywall] Restore result:', restored ? 'subscription found' : 'no purchases found');
      if (restored) {
  ...
  const handleClose = () => {
    console.log('[Paywall] Close/dismiss pressed');
